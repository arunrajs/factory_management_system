       ...
       <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!--  === -->
               <table id="Mat_list_table" class="table table-striped table-bordered" style="width:100%">
          <thead>
            <tr>
              <th>MINo</th>
              <th>Material Item</th>
...
var table = $('#Mat_list_table').DataTable( {
    ...
    $('#Mat_list_table tbody').on( 'click', '#view_id', function () {
        var data = table.row( $(this).parents('tr') ).data();
        edit_me(data[0],'edit_mat_modal','materials','MINo');
    } );

      $('#Mat_list_table tbody').on( 'click', '#delete_id', function () {
        var data = table.row( $(this).parents('tr') ).data();
        delete_me(data[0],'materials','MINo','Mat_list_table','load_mat_table');
    } );
