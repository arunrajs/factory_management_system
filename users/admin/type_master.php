...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">List of type</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
       ...
       <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <a style="float: right;color: #ffffff;background-color: #dc3545;" class="page-link" href="?f=type_master_reg">Add New type</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
...
<script type="text/javascript">
 ...
 // view_user();
    ...
    var table = $('#Country_list_table').DataTable( {
        "ajax": "php_controller/list_type.php",
        "columnDefs": [ {
            "targets": -1,
            "data": null,
    ...
    $('#Country_list_table tbody').on( 'click', '#view_id', function () {
        ...
        edit_me(data[0],'edit_type_modal','types','TypeCode');
    } );


  $('#Country_list_table tbody').on( 'click', '#delete_id', function () {
        var data = table.row( $(this).parents('tr') ).data();
        delete_me(data[0],'types','TypeCode','Country_list_table','load_types_table')
    } );
