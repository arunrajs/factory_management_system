...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">List of Countries</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
       ...
       <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <a style="float: right;color: #ffffff;background-color: #dc3545;" class="page-link" href="?f=country_master_reg">Add New Country</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
...
<script type="text/javascript">
 ...
 // view_user();
    ...
    var table = $('#Country_list_table').DataTable( {
        "ajax": "php_controller/list_country.php",
        "columnDefs": [ {
            "targets": -1,
            "data": null,
