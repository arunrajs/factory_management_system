       ...
       <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!--  === -->
               <table id="Employees_list_table" class="table table-striped table-bordered" style="width:100%">
          <thead>
            <tr>
              <th>MINo</th>
              <th>Employees</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
     ...
     var table = $('#Employees_list_table').DataTable( {
    ...
    $('#Employees_list_table tbody').on( 'click', '#view_id', function () {
        var data = table.row( $(this).parents('tr') ).data();
        edit_me(data[0],'edit_employees_modal','employees','EmpID');
    } );

      $('#Employees_list_table tbody').on( 'click', '#delete_id', function () {
        var data = table.row( $(this).parents('tr') ).data();
        delete_me(data[0],'employees','EmpID','Employees_list_table','load_employees_table');
    } );
