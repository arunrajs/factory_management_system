       ...
       <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!--  === -->
               <table id="supply_list_table" class="table table-striped table-bordered" style="width:100%">
          <thead>
            <tr>
              <th>SPID</th>
              <th>Suppliers</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    var table = $('#supply_list_table').DataTable( {
    ...
    $('#supply_list_table tbody').on( 'click', '#view_id', function () {
        var data = table.row( $(this).parents('tr') ).data();
        edit_me(data[0],'edit_suplly_modal','suppliers','SPID');
    } );

      $('#supply_list_table tbody').on( 'click', '#delete_id', function () {
        var data = table.row( $(this).parents('tr') ).data();
        delete_me(data[0],'suppliers','SPID','supply_list_table','load_supply_table');
    } );
