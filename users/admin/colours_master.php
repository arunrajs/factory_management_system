       ...
       <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!--  === -->
               <table id="colour_list_tables" class="table table-striped table-bordered resposive" style="width:100%">
          <thead>
            <tr>
              <th>ID#</th>
              <th>Colour</th>
...
<script type="text/javascript">
 ...
 var table = $('#colour_list_tables').DataTable( {
    ...
    $('#colour_list_tables tbody').on( 'click', '#view_id', function () {
        var data = table.row( $(this).parents('tr') ).data();
        edit_me(data[0],'edit_colours_modal','colours','CLCode');
    } );

      $('#colour_list_tables tbody').on( 'click', '#delete_id', function () {
        var data = table.row( $(this).parents('tr') ).data();
        delete_me(data[0],'colours','CLCode','colour_list_tables','load_colours_table');
    } );
