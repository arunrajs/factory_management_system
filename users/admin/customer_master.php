...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">List of Customers</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
       ...
       <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <a style="float: right;color: #ffffff;background-color: #dc3545;" class="page-link" href="?f=Customers_master_reg" onclick="resetSaveBtns('client_create_btn','register_new_client','master_reg_form')" data-toggle="modal" data-target="#create_client_modal">Add New Customer</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
 ...
 // view_user();
    ...
    var table = $('#user_list_tables').DataTable( {
     ...
     $('#user_list_tables tbody').on( 'click', '#delete_id', function () {
        var data = table.row( $(this).parents('tr') ).data();
        delete_me(data[0],'customers','CustID','user_list_tables','load_customer_table')
    } );
