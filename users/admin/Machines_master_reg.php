                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="row"><div class="col-sm-6">
                      ...
                      <input type="date" id="MPurchDate mandat_fld" class="form-control mandat_fld">
                    </div> </div>
                    
                    <div class="col-sm-6">
                      <div class="form-group">
                      <label>Next Service Date</label>
                      <input type="date" id="MNextServiceDate mandat_fld" class="form-control mandat_fld">
                    </div> 
                  </div></div>
